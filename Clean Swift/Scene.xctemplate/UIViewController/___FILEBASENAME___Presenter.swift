...
protocol ___FILEBASENAMEASIDENTIFIER___PresenterInput {
  func presentSomething(response: ___FILEBASENAMEASIDENTIFIER___.___VARIABLE_sceneTask___.Response)
}
...
class ___FILEBASENAMEASIDENTIFIER___Presenter: ___FILEBASENAMEASIDENTIFIER___PresenterInput {
    ...
    func presentSomething(response: ___FILEBASENAMEASIDENTIFIER___.___VARIABLE_sceneTask___.Response) {
        ...
        let viewModel = ___FILEBASENAMEASIDENTIFIER___.___VARIABLE_sceneTask___.ViewModel()
